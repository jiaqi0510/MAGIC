...
#              Saves both data and true model parameters for benchmarking.
#
# Outputs:
#   - BSseq object saved in .qs format for efficient R storage
#   - Ground truth DML annotations in CSV format  
#   - Mixture model parameters and component assignments in CSV format
#
